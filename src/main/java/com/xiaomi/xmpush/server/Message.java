...
public class Message implements Serializable {
  ...
  private final Map<String, String> apsProperFields;
  ...
  public String toString() {
    ...
    if (StringUtils.isNotEmpty(this.collapseKey))
      builder.append("collapseKey=").append(this.collapseKey).append(", ");
    if (StringUtils.isNotEmpty(this.payload))
  ...
  public static class ButtonBuilder extends ExtraBuilder
    ...
    private final Message.ButtonIndex index;

    private final Message.NotificationStyleBuilder superBuiler;
    ...
    public Map<String, String> build() {
      ...
      if (!"1".equals(this.effect))
        if ("2".equals(this.effect)) {
          switch (this.index) {
            case left:
              if (StringUtils.isNotBlank(this.intentUri))
