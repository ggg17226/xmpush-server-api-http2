...
public class Constants {
  ...
  public static boolean autoSwitchHost = true;
  ...
  static String HOST_EMQ = "emq.xmpush.xiaomi.com";
  ...
  static String HOST_GLOBAL_PRODUCTION = "api.xmpush.global.xiaomi.com";

  static String HOST_GLOBAL_PRODUCTION_FEEDBACK = "feedback.xmpush.global.xiaomi.com";

  static String HOST_EUROPE_PRODUCTION = "fr.api.xmpush.global.xiaomi.com";

  static String HOST_EUROPE_PRODUCTION_FEEDBACK = "fr.feedback.xmpush.global.xiaomi.com";

  static String HOST_RUSSIA_PRODUCTION = "ru.api.xmpush.global.xiaomi.com";

  static String HOST_RUSSIA_PRODUCTION_FEEDBACK = "ru.feedback.xmpush.global.xiaomi.com";

  static String HOST_INDIA_PRODUCTION = "idmb.api.xmpush.global.xiaomi.com";

  static String HOST_INDIA_PRODUCTION_FEEDBACK = "idmb.feedback.xmpush.global.xiaomi.com";

  static String HOST_VIP = "vip.api.xmpush.xiaomi.com";

  static boolean sandbox = false;

  static String host = null;

  static boolean useOkHttp3 = true;
  ...
  enum XmPushRequestPath implements RequestPath {
    ...
    V1_FEEDBACK_INVALID_ALIAS(
        "/v1/feedback/fetch_invalid_aliases", Constants.XmPushRequestType.FEEDBACK),
    V1_FEEDBACK_INVALID_REGID(
        "/v1/feedback/fetch_invalid_regids", Constants.XmPushRequestType.FEEDBACK),
    V1_FEEDBACK_INVALID_MIID(
        "/v1/feedback/fetch_invalid_miid", Constants.XmPushRequestType.FEEDBACK),
    V1_FEEDBACK_REGID_REGION(
        "/v1/feedback/get_region_by_regid", Constants.XmPushRequestType.FEEDBACK),
    ...
    V1_EMQ_ACK_INFO("/msg/ack/info", Constants.XmPushRequestType.EMQ),
    V1_EMQ_CLICK_INFO("/msg/click/info", Constants.XmPushRequestType.EMQ),
    V1_EMQ_INVALID_REGID("/app/invalid/regid", Constants.XmPushRequestType.EMQ),
    V1_REVOKE_MESSAGE("/revoke/message", Constants.XmPushRequestType.MESSAGE),
    V2_GEO_MESSAGE("/v2/message/geo", Constants.XmPushRequestType.MESSAGE),
    V2_GEO_GROUP_MESSAGE("/v2/message/geo_group", Constants.XmPushRequestType.MESSAGE),
    V1_CREATE_GEO_FENCING("/geo/circle/create", Constants.XmPushRequestType.MESSAGE),
    V1_REGISTER_GEO_FENCING("/geo/circle/register", Constants.XmPushRequestType.MESSAGE),
    V1_QUERY_REGISTERED_GEO_FENCING("/geo/circle/list", Constants.XmPushRequestType.MESSAGE),
    V1_DELETE_GEO_FENCING("/geo/circle/delete", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_CREATE("/geo/group/create", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_DELETE("/geo/group/delete", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_RENAME("/geo/group/rename", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_REGISTER("/geo/group/register", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_FENCING_ADD("/geo/group/fencing/add", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_FENCING_REMOVE(
        "/geo/group/fencing/remove", Constants.XmPushRequestType.MESSAGE),
    V1_GEO_FENCING_GROUP_FENCING_ALL("/geo/group/fencing/all", Constants.XmPushRequestType.MESSAGE),
    V1_APP_GEO_FENCING_GROUP_ALL("/geo/app/group/all", Constants.XmPushRequestType.MESSAGE),
    ...
    XmPushRequestPath(String path, Constants.XmPushRequestType requestType) {
      this.path = path;
    ...
    public Constants.XmPushRequestType getRequestType() {
  ...
  interface RequestPath {
    ...
    Constants.XmPushRequestType getRequestType();
  }

  public interface NotificationStyleExtra {
    String STYLE_TYPE_BIG_TEXT = "1";

    String STYLE_TYPE_BIG_PICTURE = "2";

    String LARGE_ICON_URI = "notification_large_icon_uri";

    String STYLE_TYPE = "notification_style_type";

    String BIG_PIC_URI = "notification_bigPic_uri";

    String STYLE_BUTTON_LEFT_NAME = "notification_style_button_left_name";

    String STYLE_BUTTON_MID_NAME = "notification_style_button_mid_name";

    String STYLE_BUTTON_RIGHT_NAME = "notification_style_button_right_name";

    String STYLE_BUTTON_LEFT_NOTIFY_EFFECT = "notification_style_button_left_notify_effect";

    String STYLE_BUTTON_MID_NOTIFY_EFFECT = "notification_style_button_mid_notify_effect";

    String STYLE_BUTTON_RIGHT_NOTIFY_EFFECT = "notification_style_button_right_notify_effect";

    String STYLE_BUTTON_LEFT_INTENT_URI = "notification_style_button_left_intent_uri";

    String STYLE_BUTTON_MID_INTENT_URI = "notification_style_button_mid_intent_uri";

    String STYLE_BUTTON_RIGHT_INTENT_URI = "notification_style_button_right_intent_uri";

    String STYLE_BUTTON_LEFT_INTENT_CLASS = "notification_style_button_left_intent_class";

    String STYLE_BUTTON_MID_INTENT_CLASS = "notification_style_button_mid_intent_class";

    String STYLE_BUTTON_RIGHT_INTENT_CLASS = "notification_style_button_right_intent_class";

    String STYLE_BUTTON_LEFT_WEB_URI = "notification_style_button_left_web_uri";

    String STYLE_BUTTON_MID_WEB_URI = "notification_style_button_mid_web_uri";

    String STYLE_BUTTON_RIGHT_WEB_URI = "notification_style_button_right_web_uri";
  ...
  interface Hybrid {
    String PUSH_ACTION = "push_server_action";

    String PUSH_ACTION_MESSAGE = "hybrid_message";

    String PUSH_DEBUG = "hybrid_debug";

    String EXTRA_PARAM_HYBRID_PATH = "hybrid_pn";
  }
}
